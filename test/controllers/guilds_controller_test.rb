...
class GuildsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guild" do
    assert_difference('Guild.count') do
      post guilds_url, params: { guild: { private: @guild.private, prop_threshold: @guild.prop_threshold, references: @guild.references } }
    end
  ...
  test "should update guild" do
    patch guild_url(@guild), params: { guild: { private: @guild.private, prop_threshold: @guild.prop_threshold, references: @guild.references } }
